...
def mainGame():
    ...
    while True:
        ...
        crashTest = isCollide(playerx, playery, Pipes) # This function will return true if the player is crashed
        if crashTest:
            return     
...
def getRandomPipe():
    ...
    y1 = offset + random.randrange(0, int(SCREENHEIGHT - GAME_SPRITES['base'].get_height()  - 1.2 *offset))
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('welcome to Flappy Bird')
    ...
    GAME_SPRITES['message'] = pygame.image.load('gallery/splash.png').convert_alpha()
